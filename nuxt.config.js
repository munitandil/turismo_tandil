    ...
    head: {
        ...
        meta: [{
            ...
            },
            {
                hid: 'description',
                name: 'description',
                content: 'Actualidad y Eventos Culturales en Tandil'
            },
            {
                hid: 'keywords',
                name: 'keywords',
                content: 'turismo, tandil, novedades, sierras, cultura, municipalidad, contactos, informacion'
            }
        ],
        link: [{
                rel: 'icon',
